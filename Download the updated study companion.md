...
>
> **Four parts:**
> 1. **Hands-on Practice Workbook** — 12 labs including a capstone, runnable in a safe repo
> 2. **Quick-Reference Cheat Sheets** — 13 cards to keep open while you work
> 3. **Advanced Deep-Dives** — hooks internals, MCP design, subagent orchestration, CI/CD, the Agent SDK, Claude Code on the web
...
- **Architecture Guide** (`Claude_Code_Architecture_Operations_Guide.md`) — the enterprise/ops reference (verify specific claims against official docs before production use).
