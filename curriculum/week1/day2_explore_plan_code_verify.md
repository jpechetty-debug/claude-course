...
- agentic-engineering
- week1
title: 'Week 1 - Day 2: The 5-Step Feedback Loop: Explore, Plan, Code, Verify, Report'
week: 1
---

# Week 1 - Day 2: The 5-Step Feedback Loop: Explore, Plan, Code, Verify, Report

## Overview
**Week 1 – Day 2**  
**Topic:** The 5-Step Feedback Loop: Explore, Plan, Code, Verify, Report  
**Duration:** ~75 minutes  
**Difficulty:** Beginner

### Learning Objectives
By the end of this lesson, you will be able to:
1. Explain the underlying architecture and protocol mechanics of the 5-step feedback loop: explore, plan, code, verify, report.
