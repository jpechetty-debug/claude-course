...
- agentic-engineering
- week8
title: 'Week 8 - Day 3: Security Auditing & OWASP SAST Remediation Bot'
week: 8
---

# Week 8 - Day 3: Security Auditing & OWASP SAST Remediation Bot

## Overview
**Week 8 – Day 3**  
**Topic:** Security Auditing & OWASP SAST Remediation Bot  
**Duration:** ~90 minutes  
**Difficulty:** Expert

### Learning Objectives
By the end of this lesson, you will be able to:
1. Explain the underlying architecture and protocol mechanics of security auditing & owasp sast remediation bot.
