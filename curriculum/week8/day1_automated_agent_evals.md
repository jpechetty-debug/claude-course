...
- agentic-engineering
- week8
title: 'Week 8 - Day 1: Automated Agent Evals & Regression Testing Harness'
week: 8
---

# Week 8 - Day 1: Automated Agent Evals & Regression Testing Harness

## Overview
**Week 8 – Day 1**  
**Topic:** Automated Agent Evals & Regression Testing Harness  
**Duration:** ~75 minutes  
**Difficulty:** Expert

### Learning Objectives
By the end of this lesson, you will be able to:
1. Explain the underlying architecture and protocol mechanics of automated agent evals & regression testing harness.
