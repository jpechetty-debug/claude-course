...
- agentic-engineering
- week5
title: 'Week 5 - Day 2: Authoring Python FastMCP Server with Custom Tools'
week: 5
---

# Week 5 - Day 2: Authoring Python FastMCP Server with Custom Tools

## Overview
**Week 5 – Day 2**  
**Topic:** Authoring Python FastMCP Server with Custom Tools  
**Duration:** ~75 minutes  
**Difficulty:** Advanced

### Learning Objectives
By the end of this lesson, you will be able to:
1. Explain the underlying architecture and protocol mechanics of authoring python fastmcp server with custom tools.
