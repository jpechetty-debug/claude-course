...
- agentic-engineering
- week7
title: 'Week 7 - Day 5: Multi-Cloud Enterprise IAM Routing: AWS Bedrock & GCP Vertex'
week: 7
---

# Week 7 - Day 5: Multi-Cloud Enterprise IAM Routing: AWS Bedrock & GCP Vertex

## Overview
**Week 7 – Day 5**  
**Topic:** Multi-Cloud Enterprise IAM Routing: AWS Bedrock & GCP Vertex  
**Duration:** ~90 minutes  
**Difficulty:** Expert

### Learning Objectives
By the end of this lesson, you will be able to:
1. Explain the underlying architecture and protocol mechanics of multi-cloud enterprise iam routing: aws bedrock & gcp vertex.
