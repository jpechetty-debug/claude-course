...
- agentic-engineering
- week7
title: 'Week 7 - Day 2: Autonomous GitHub Actions PR Review Bot'
week: 7
---

# Week 7 - Day 2: Autonomous GitHub Actions PR Review Bot

## Overview
**Week 7 – Day 2**  
**Topic:** Autonomous GitHub Actions PR Review Bot  
**Duration:** ~75 minutes  
**Difficulty:** Expert

### Learning Objectives
By the end of this lesson, you will be able to:
1. Explain the underlying architecture and protocol mechanics of autonomous github actions pr review bot.
