...
- agentic-engineering
- week2
title: 'Week 2 - Day 4: Hierarchical Steering & Subdirectory CLAUDE.md'
week: 2
---

# Week 2 - Day 4: Hierarchical Steering & Subdirectory CLAUDE.md

## Overview
**Week 2 – Day 4**  
**Topic:** Hierarchical Steering & Subdirectory CLAUDE.md  
**Duration:** ~75 minutes  
**Difficulty:** Intermediate

### Learning Objectives
By the end of this lesson, you will be able to:
1. Explain the underlying architecture and protocol mechanics of hierarchical steering & subdirectory claude.md.
