...
- agentic-engineering
- week2
title: 'Week 2 - Day 3: Fast Interruption (Esc) & Direction Course-Correction'
week: 2
---

# Week 2 - Day 3: Fast Interruption (Esc) & Direction Course-Correction

## Overview
**Week 2 – Day 3**  
**Topic:** Fast Interruption (Esc) & Direction Course-Correction  
**Duration:** ~60 minutes  
**Difficulty:** Beginner

### Learning Objectives
By the end of this lesson, you will be able to:
1. Explain the underlying architecture and protocol mechanics of fast interruption (esc) & direction course-correction.
