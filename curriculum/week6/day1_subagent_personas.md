...
- agentic-engineering
- week6
title: 'Week 6 - Day 1: Context-Isolated Subagents in .claude/agents/'
week: 6
---

# Week 6 - Day 1: Context-Isolated Subagents in .claude/agents/

## Overview
**Week 6 – Day 1**  
**Topic:** Context-Isolated Subagents in .claude/agents/  
**Duration:** ~60 minutes  
**Difficulty:** Advanced

### Learning Objectives
By the end of this lesson, you will be able to:
1. Explain the underlying architecture and protocol mechanics of context-isolated subagents in .claude/agents/.
