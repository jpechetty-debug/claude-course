...
- agentic-engineering
- week6
title: 'Week 6 - Day 3: Git Worktree Fleets: Parallel Concurrent Claude Sessions'
week: 6
---

# Week 6 - Day 3: Git Worktree Fleets: Parallel Concurrent Claude Sessions

## Overview
**Week 6 – Day 3**  
**Topic:** Git Worktree Fleets: Parallel Concurrent Claude Sessions  
**Duration:** ~75 minutes  
**Difficulty:** Expert

### Learning Objectives
By the end of this lesson, you will be able to:
1. Explain the underlying architecture and protocol mechanics of git worktree fleets: parallel concurrent claude sessions.
