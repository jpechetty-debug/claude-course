...
- agentic-engineering
- week6
title: 'Week 6 - Day 2: Subagent Model Tiering: Haiku, Sonnet & Opus'
week: 6
---

# Week 6 - Day 2: Subagent Model Tiering: Haiku, Sonnet & Opus

## Overview
**Week 6 – Day 2**  
**Topic:** Subagent Model Tiering: Haiku, Sonnet & Opus  
**Duration:** ~60 minutes  
**Difficulty:** Advanced

### Learning Objectives
By the end of this lesson, you will be able to:
1. Explain the underlying architecture and protocol mechanics of subagent model tiering: haiku, sonnet & opus.
