...
- agentic-engineering
- week3
title: 'Week 3 - Day 2: Dynamic File Context Pinning with @ Syntax'
week: 3
---

# Week 3 - Day 2: Dynamic File Context Pinning with @ Syntax

## Overview
**Week 3 – Day 2**  
**Topic:** Dynamic File Context Pinning with @ Syntax  
**Duration:** ~60 minutes  
**Difficulty:** Intermediate

### Learning Objectives
By the end of this lesson, you will be able to:
1. Explain the underlying architecture and protocol mechanics of dynamic file context pinning with @ syntax.
