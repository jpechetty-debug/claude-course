...
- agentic-engineering
- week3
title: 'Week 3 - Day 3: In-Place Context Compaction with /compact'
week: 3
---

# Week 3 - Day 3: In-Place Context Compaction with /compact

## Overview
**Week 3 – Day 3**  
**Topic:** In-Place Context Compaction with /compact  
**Duration:** ~60 minutes  
**Difficulty:** Intermediate

### Learning Objectives
By the end of this lesson, you will be able to:
1. Explain the underlying architecture and protocol mechanics of in-place context compaction with /compact.
